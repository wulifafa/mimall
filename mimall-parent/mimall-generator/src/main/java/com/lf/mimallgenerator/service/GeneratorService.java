...
//        strategy.setEntityTableFieldAnnotationEnable(false);
       ...
       // strategy.setColumnNaming(NamingStrategy.underline_to_camel);
        ...
        // mapper 父类
        strategy.setSuperMapperClass("com.jiuair.cloud.data.common.core.mybatis.base.entity.SuperMapper");
        // 实体父类
        strategy.setSuperEntityClass("com.jiuair.cloud.data.common.core.mybatis.base.entity.AbstractEntity2");
        // 接口父类
        strategy.setSuperServiceClass("com.jiuair.cloud.data.common.core.mybatis.base.service.IBaseService");
        // 接口实现类父类
        strategy.setSuperServiceImplClass("com.jiuair.cloud.data.common.core.mybatis.base.service.impl.BaseServiceImpl");
        // 需要生成的表
...
//        strategy.setTableFillList(tableFills);  //注释，不要公共字段，按实际数据库字段生成
